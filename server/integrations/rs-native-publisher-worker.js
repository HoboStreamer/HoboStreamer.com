/**
 * HoboStreamer — RobotStreamer native publisher (worker process)
 *
 ...
 *
 * Adapted from hobo.quest's rs-browser-to-robotstreamer-native publisher.
 */
'use strict';
...
async function main() {
    ...
    const videoProducer = await sendTransport.produce({
        ...
        appData: { source: 'hobostreamer-native-relay' },
    });
    ...
    if (hasAudio) {
        const audioProducer = await sendTransport.produce({
            ...
            appData: { source: 'hobostreamer-native-relay', lowLatency: true },
        });
